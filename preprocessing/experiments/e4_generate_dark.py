...
Salva em dataset/exports/epi-v6-dark/ mantendo os labels originais. 
...
SRC  = Path("dataset/exports/epi-v6/valid") 

DEST = Path("dataset/exports/epi-v6-dark/valid") 
...
print("  cp dataset/exports/epi-v6/data.yaml dataset/exports/epi-v6-dark/") 
